...
if [ -d '/data/data/com.termux' ]; then
    ...
    pkg update -y
    pkg upgrade -y
    pkg install lsd bat zsh zsh-completions neovim wget tmux $tvenv -y
...
# detect if arch
    ...
    echo 'Arch detected'
    sudo pacman -Syuv lsd bat zsh zsh-completions neovim thefuck kitty wget tmux $venv --noconfirm
    mkdir ~/.local/share/fonts
    wget https://github.com/romkatv/powerlevel10k-media/raw/master/MesloLGS%20NF%20Regular.ttf -P ~/.local/share/fonts/
fi
